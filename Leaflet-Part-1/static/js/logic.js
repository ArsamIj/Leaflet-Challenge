...
d3.json(link).then(function(data){
    ...
    L.geoJSON(data,{
        pointToLayer: function(feature,latlng){
            return L.circleMarker(latlng).bindPopup(`<h3>Location: ${feature.properties.place}<h3><hr>
            <h3>Earthquake Magnitude: ${feature.properties.mag}<h3><h3> Depth: ${feature.geometry.coordinates[2]}`);
        },
        style: styleInfo,
    }).addTo(earthquakes);
})
